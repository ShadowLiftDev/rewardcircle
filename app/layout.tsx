...
export const metadata: Metadata = {
  title: "OwnerOptics",
  description:
    "A connected operating system for local growth, rewards, referrals, customer profiles, and business intelligence.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable} ${geistMono.variable} relative min-h-screen overflow-x-hidden bg-slate-950 text-slate-50 antialiased`}
      >
